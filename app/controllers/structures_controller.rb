class StructuresController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @structure.update(structure_params)
        format.html { redirect_to @structure, notice: "Structure was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to structures_path, notice: "Structure was successfully destroyed.", status: :see_other }
